    ...
    <div className="conte">
      ...
      <header class="cabeceraPrincipal">
        ...
        <nav class="menuPrincipal2">
          <a href="/signin/">
            <button class="botonMenu1"><Link to={ user? isLogged : isNotLogged}>Ingreso </Link></button>
          </a>
          <a href="/signup">
      ...
      <section class="sliderPrincipal">
        ...
        <div class="botonesPortada">
          <a href="/">
            <button class="botonPortada1"><Link to={ user? isLogged : isNotLogged}>INGRESAR</Link></button>
          </a>
          <a href="#">
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src={require("./images/slider1.jpg")} class="d-block w-100" alt="fondo1"/>
            ...
            <div class="carousel-item">
              <img src={require("./images/slider2.jpg")} class="d-block w-100" alt="fondo2"/>
              <div class="carousel-caption d-none d-md-block">
                <h3>¿QUÉ CONSIDERAMOS?</h3>
            ...
            <div class="carousel-item">
              <img src={require("./images/slider3.jpg")} class="d-block w-100" alt="fondo3"/>
              <div class="carousel-caption d-none d-md-block">
                <h3>¿QUÉ CONSIDERAMOS?</h3>
      ...
      <section class="graficas" id="graficas">
        ...
        <select name="dog-names">
          <option value="rigatoni">PALANDA</option>
          <option value="dave">SANTA ISABEL</option>
          <option value="pumpernickel">TENA</option>
          <option value="reeses">EL CHALCO</option>
        </select>
      </section>
      ...
      <section class="objetivo" id="objetivo">
        ...
        <div class="ConceptoObjetivo"> El objetivo de esta propuesta es desarrollar una plataforma <br/>para evaluar la gestión ambiental del municipio de Loja,<br/> permitiendo a la sociedad en general conocer el nivel de<br/> gestión del gobierno local.</div>
		    <div class="imag">
          <img src={require("./images/fotoObjetivo.jpg")} />
    	    ...
    	    <a href="/signin"><br/>
    	    <button class="botonObjetivo2"><Link to={ user? isLogged : isNotLogged}>Únete</Link></button></a>  
    	    <a href="#"><br/>
      ...
      <section class="sponsor" id="sponsor">
        <p class="centroSponsor"><b>¿Quiénes nos apoyan?</b></p>
      ...
      <footer class="piePagina">
        ...
        <div class="textoFooter1">
          ...
          <p>Indicador Económico Sustentable <br/>
